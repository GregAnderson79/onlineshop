...
class SetItemImg_Contr extends SetItemImg_Model {
    public $itemID;
    public $altTag;
    public $caption;
    public $image;
    ...
    public function contr_setItemImg() {
    ...
    // Model
    private function setItemImg($imgName) {
        return $this->model_setItemImg($imgName);
    }
