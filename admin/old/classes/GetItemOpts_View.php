...
// Get options in item options panel
class GetItemOpts_View extends GetOptions_Contr {
    public $itemID;
            ...
            foreach ($options as $i) {
                ...
                if ($i['selected'] == true) {
                    if ($i['selectedValues'] == true) {
                        ...
                        $this->view_itemOptValues($i['optID']);
                } else {
    ...
    // values
    public function view_itemOptValues($optID) {
